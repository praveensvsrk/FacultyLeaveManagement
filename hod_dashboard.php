...
Welcome,HOD
	...
	<div class="fl-row-padding fl-margin-top">
		<a href="hod_details.php" class="fl-ripple fl-margin fl-hover-red fl-btn fl-xlarge">
			Details
		</a>
		<a href="sanctioned.php" class="fl-ripple fl-margin fl-hover-red fl-btn  fl-xlarge">
			Sanctioned Applications
		</a>
		<a href="pending.php" class="fl-ripple fl-margin fl-hover-red fl-btn fl-xlarge">
